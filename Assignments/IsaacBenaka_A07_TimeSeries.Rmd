...
GaringerOzonelist <- list(O10, O11, O12, O13, O14, O15, O16, O17, O18, O19)
GaringerOzone <- GaringerOzonelist %>% reduce(full_join, by="POC")
```
...
GaringerOzone <- GaringerOzone %>%
  filter(Date, Daily.Max.8.hour.Ozone.Concentration, DAILY_AQI_VALUE)
# 5
