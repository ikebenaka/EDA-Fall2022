...
```{r}
#7
EPA.ATM <- rbind(EPA.O3.2018.processed, EPA.O3.2019.processed, EPA.PM25.2018.processed, EPA.PM25.2019.processed)
...
EPA.ATM.summary <- 
  ...
  #filter(!is.na(mean.AQI.Ozone) & !is.na(mean.AQI.PM2.5))
