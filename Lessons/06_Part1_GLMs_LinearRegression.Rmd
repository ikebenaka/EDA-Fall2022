...
TPAIC <- lm(data = Paul.naomit, tp_ug ~ depth + dissolvedOxygen + 
              temperature_C + tn_ug + po4) #tu_ug will be a function of depth, DO, T, nitrogen content, and phosphorus content. We are considering these 5 variables to be explanatory variables.
