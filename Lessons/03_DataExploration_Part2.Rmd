...
# Changes the number of bars that are displayed. Makes the data look smoother because there are more bins/bars.
ggplot(USGS.flow.data) +
...
# Force x to go from 0-500. Removes all the empty space on the chart.
