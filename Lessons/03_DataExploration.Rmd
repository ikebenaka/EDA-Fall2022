...
# add the stringsAsFactors = TRUE when importing a csv file and want to have all the data be factors
...
# the % operator is used to change the format of a variable
