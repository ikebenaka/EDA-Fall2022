...
Endpointplots <- ggplot(Neonics, aes(x = Endpoint)) +
  geom_bar()
Endpointplots + theme(axis.text.x = element_text(size = 5))  
```

> Answer: LOEL and NOEL are the two most common end points. LOEL stands for lowest-observable-effect-level and NOEL stands for no-observable-effect-level.
...
> Answer: Needles tended to compose the largest amount of biomass at the sites.
